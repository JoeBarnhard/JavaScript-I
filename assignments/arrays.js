...
for(let i=0; i <= inventory.length; i++) {
    ...
    // console.log("This is length of invetory" + inventory.length);
...
console.log("The last car is " + lastCar.car_make, lastCar.car_model, lastCar.car_year); //{"id":50,"car_make":"Lincoln","car_model":"Town Car","car_year":1999}
...
let BMWAndAudi = [];
//BMW Audi car makes   return array only returns BMW Audi's 
